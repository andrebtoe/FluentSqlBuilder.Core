...
namespace SqlBuilderFluent.Core.Implementations.SqlServer.Inputs
{
    public class SqlServerSelectBuildInput
    {
        ...
        private string GetSelectFormattingNone()
        {
            ...
            sqlSelect.Append($"{_where} {_order} {_grouping} {_having} {_appendBottom}");
